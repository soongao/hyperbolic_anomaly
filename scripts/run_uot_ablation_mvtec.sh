...
DATA_PATH="$1"
CHECKPOINT_PATH="$2"
SAVE_ROOT="${3:-./results/uot_ablation_mvtec}"
...
run_variant bot_cosine \
  --score_mode hyperbolic_uot \
  --ot_mode balanced \
  --ot_cost cosine \
  --ot_score cost

run_variant bot_hyperbolic_cone \
  --score_mode hyperbolic_uot \
  --ot_mode balanced \
  --ot_cost hyperbolic_cone \
  --ot_score cost

run_variant pot_hyperbolic_cone \
  --score_mode hyperbolic_uot \
  --ot_mode partial \
  --ot_cost hyperbolic_cone \
  --ot_score combined \
...
run_variant uot_cosine \
  --score_mode hyperbolic_uot \
  --ot_mode unbalanced \
  --ot_cost cosine \
  --ot_score combined

run_variant uot_euclidean \
  --score_mode hyperbolic_uot \
  --ot_mode unbalanced \
  --ot_cost euclidean \
  --ot_score combined

run_variant uot_hyperbolic_distance \
  --score_mode hyperbolic_uot \
  --ot_mode unbalanced \
  --ot_cost hyperbolic_distance \
  --ot_score combined

run_variant uot_hyperbolic_cone \
  --score_mode hyperbolic_uot \
  --ot_mode unbalanced \
  --ot_cost hyperbolic_cone \
  --ot_score combined
